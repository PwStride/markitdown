...
GENERAL_TEST_VECTORS = [
    ...
    FileTestVector(
        ...
        must_include=[
            ...
            "### Date and Time",
            "**Start:** March 15, 2025, 10:00 AM",
            "**End:** March 15, 2025, 11:30 AM",
            "### Location",
            "Conference Room 4B, 123 Main St, Building A",
            "### Organizer",
            "Jane Smith <jane.smith@example.com>",
            "### Attendees",
            "- Bob Johnson (Accepted)",
            "- Alice Wong (Opt Participant, Tentative)",
            "- Charlie Davis (Declined)",
            "### Description",
            "Quarterly sprint planning session",
            "## Product Roadmap Review",
            "Diana Prince <diana.prince@example.com>",
            "Virtual - Zoom Meeting Room",
            "Frank Miller (Pending)",
            "## Team Lunch Outing",
            "Rosewood Bistro, 456 Oak Avenue",
            "## Remote Check-In",
            "No location specified",
            "Bob Johnson <bob.johnson@example.com>",
            "Weekly async check-in for remote team members",
        ],
        must_not_include=[
            "BEGIN:VCALENDAR",
            "VEVENT",
